                ...
                <div class="box-body">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" name="name" value="{{$domain->name}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <label class="checkbox-inline">
                                <input type="checkbox" name="closed" id="three" value="1" @if($domain->closed == 1) checked  @endif> Исключить
                            </label>
                        </div>
                        <div class="form-group">
